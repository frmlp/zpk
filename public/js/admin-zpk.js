$(document).ready(function() {
    ...
    $('#pointForm').on('submit', function(event) {
        ...
        // let pointTags = collectPoints('#dropdown-container select', tags).map(tag => tag.id);

        // $('#pointForm input[name="tags"]').remove();

        // if (pointTags.length === 0) {
        //     pointTags = $('<input>').attr({
        //         type: 'hidden',
        //         name: 'tags[]',
        //         value: ''
        //     }).appendTo('#pointForm');;
        // } else {
        //     pointTags.forEach(tag => {
        //         $('<input>').attr({
        //             type: 'hidden',
        //             name: 'tags[]',
        //             value: tag
        ...
        const data = {
            ...
            tag_ids: pointTags,// Konwersja string na tablicę
            // _method: mode
        };
